...
| Gerelateerd | ADR-0001 (Stackable als basis), ADR-0005 (dbt-trino) |
...
|---|---|---|
| ACID transactions | ✅ | ✅ |
| Schema evolution | ✅ (met partition evolution) | ✅ (geen partition evolution) |
| Time travel | ✅ (snapshots) | ✅ (versions) |
| Hidden partitioning | ✅ | ❌ (vereist generated columns) |
| Z-ordering / clustering | Via Spark sort | ✅ (Z-order, Liquid Clustering) |
| Branching / tagging | ✅ (Spark, Trino in ontwikkeling) | ❌ |
| Materialized views in Trino | ✅ native | ❌ (omweg via Iceberg) |
| Deletion vectors | ✅ (v3 spec) | ✅ |
| Change Data Feed | Via snapshots + diff | ✅ native |
| Branching (git-like) | ✅ | ❌ |
