...
export const shortcuts: Record<RoleId, Shortcut[]> = {
  ...
  data_engineer: [
    ...
    { title: 'Grafana dashboards', hint: 'Pipeline-latency, Spark/Trino metrics — login via Keycloak', component: 'grafana', href: 'https://grafana.uwv-platform.local:8443' },
  ...
  platform_admin: [
    ...
    { title: 'Grafana dashboards', hint: 'Cluster-health en service-latency — login via Keycloak SSO', component: 'grafana', href: 'https://grafana.uwv-platform.local:8443' },
