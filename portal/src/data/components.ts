...
export const components: PlatformComponent[] = [
  {
    ...
    url: 'https://keycloak.uwv-platform.local',
  ...
  },
  {
    ...
    url: 'https://minio.uwv-platform.local',
    prometheusJob: 'minio',
  ...
  },
  {
    ...
    url: 'https://nifi.uwv-platform.local',
    prometheusJob: 'nifi',
    rolesUsing: ['platform_admin', 'data_engineer'],
  },
  {
  ...
  },
  {
    ...
    url: 'https://trino.uwv-platform.local',
    prometheusJob: 'trino',
    rolesUsing: [
      'wia_beoordelaar',
      'ww_handhaver',
  ...
  },
  {
    ...
    url: 'https://airflow.uwv-platform.local',
  ...
  },
  {
    ...
    url: 'https://superset.uwv-platform.local',
  ...
  },
  {
    ...
    url: 'https://openmetadata.uwv-platform.local',
